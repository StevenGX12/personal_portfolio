...
export default function MyPortfolio() {
  const redirectToGithub = (url) => {
    window.open(url, "_blank"); // Opens the GitHub link in a new tab
  };
  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a href="https://github.com/StevenGX12" className="portfolio--btn--link">
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <p className="text-sm portfolio--link" onClick={() => redirectToGithub(item.link)}>
                View in Github
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
